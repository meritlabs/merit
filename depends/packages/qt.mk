PACKAGE=qt
$(package)_version_major=5.9
$(package)_version=$($(package)_version_major).4
$(package)_download_path=http://download.qt.io/official_releases/qt/$($(package)_version_major)/$($(package)_version)/submodules
