...
This document provides guidelines for internationalization of the Merit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `merit_en.ts` remains unchanged.
