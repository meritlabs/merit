...
#ifndef MERIT_VERSION_H
#define MERIT_VERSION_H

/**
 * network protocol versioning
 */

static const int PROTOCOL_VERSION = 14000;
...
static const int INVALID_CB_NO_BAN_VERSION = 14000;

#endif // MERIT_VERSION_H
