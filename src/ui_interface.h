...
#ifndef MERIT_UI_INTERFACE_H
#define MERIT_UI_INTERFACE_H
...
public:
    ...
    /** Mining started. */
    boost::signals2::signal<void (void)> MiningStarted;

    /** Mining stopped. */
    boost::signals2::signal<void (void)> MiningStopped;
};
