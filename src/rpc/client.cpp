...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "getnetworkcyclesps", 0, "nblocks" },
    { "getnetworkcyclesps", 1, "height" },
    ...
    { "listinvites", 0, "addresses" },
    { "inviteaddress", 1, "amount" },
    ...
    { "getrawtransaction", 2, "completecheck" },
    ...
    { "getaddressleaderboard", 0, "addresses"},
    { "getaddressdeltas", 0, "addresses"},
    { "getaddressutxos", 0, "addresses"},
    { "getaddressmempool", 0, "addresses"},
    { "getaddressmempoolreferrals", 0, "addresses"},
