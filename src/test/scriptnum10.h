...
#ifndef MERIT_TEST_SCRIPTNUM10_H
#define MERIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Merit Core 0.10.0, for cross-comparison.
 */
public:
