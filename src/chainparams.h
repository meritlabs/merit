...
#ifndef MERIT_CHAINPARAMS_H
#define MERIT_CHAINPARAMS_H
 ...
 * Merit system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string SnapshotUrl() const { return snapshot_url;}
