...
#ifndef MERIT_QT_MERITUNITS_H
#define MERIT_QT_MERITUNITS_H
...
/** Merit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MeritUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MeritUnits(QObject *parent);

    /** Merit units.
      @note Source: https://en.merit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MRT,
...
typedef MeritUnits::Unit MeritUnit;

#endif // MERIT_QT_MERITUNITS_H
