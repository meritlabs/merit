...
#ifndef MERIT_QT_WALLETMODEL_H
#define MERIT_QT_WALLETMODEL_H
...
/** Interface to Merit wallet from Qt view code. */
...
public:
    ...
    bool DeclineInviteTo(const std::string& address);
