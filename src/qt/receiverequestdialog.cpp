...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMeritURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MeritUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMeritURI(info));
}
