...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MeritTestFramework
    pass

class ExampleTest(MeritTestFramework):
    # Each functional test is a subclass of the MeritTestFramework class.
    ...
    def custom_method(self):
        ...
        MeritTestFramework class so other tests can use it."""
