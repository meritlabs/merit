...
# TestNode: A peer we use to send messages to meritd, and store responses.
...
class CompactBlocksTest(MeritTestFramework):
    ...
    # This test actually causes meritd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that meritd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for meritd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # meritd will not send blocktxn responses for blocks whose height is
