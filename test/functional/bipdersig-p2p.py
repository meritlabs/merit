...
class BIP66Test(MeritTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # meritd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and meritd produces more specific reject
            # reasons.
