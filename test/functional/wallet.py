...
class WalletTest(MeritTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MRT from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 MRT in block rewards plus fees, but
        ...
        # Send 10 MRT with subtract fee from amount
        ...
        # Sendmany 10 MRT with subtract fee from amount
