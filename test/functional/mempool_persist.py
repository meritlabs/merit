...
By default, meritd will dump mempool on shutdown and
...
class MempoolPersistTest(MeritTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give meritd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent meritd from writing mempool.dat to disk. Verify that `savemempool` fails")
