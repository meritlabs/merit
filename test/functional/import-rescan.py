...
import RPC call and node 0 sends MRT to it. Then other nodes import the
...
In the second part of the test, node 0 sends more MRT to each address, and the
...
class ImportRescanTest(MeritTestFramework):
